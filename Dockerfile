...
# Set environment variables - ADVANCED FIXED VERSION
...
# Run the ADVANCED FIXED application
CMD ["uvicorn", "main_advanced_fixed:app", "--host", "0.0.0.0", "--port", "8080", "--workers", "1"]